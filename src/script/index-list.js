    ...
    require(['jquery', 'jq_lazyload', 'jq_cookie'], function() {;
        return {
            index_list_f: ! function() {
                var list_f = $('.list-f');
                $.ajax({ //获取远程接口的值
                    url: 'http://10.31.163.210/YOHOBUY/php/indexlist-f.php',
                    dataType: 'json'
                }).done(function(data) {
                    // console.log(data);
                    var strhtml = '';
            ...
            index_list_s: ! function() {
                var list_s = $('.list-s');
                $.ajax({ //获取远程接口的值
                    url: 'http://10.31.163.210/YOHOBUY/php/indexlist-s.php',
                    dataType: 'json'
                }).done(function(data) {
                    // console.log(data);
                    var strhtml = '';
            ...
            index_list_t: ! function() {
                var list_t = $('.list-t');
                $.ajax({ //获取远程接口的值
                    url: 'http://10.31.163.210/YOHOBUY/php/indexlist-t.php',
                    dataType: 'json'
                }).done(function(data) {
                    // console.log(data);
                    var strhtml = '';
            ...
            index_list_fo: ! function() {
                var list_fo = $('.list-fo');
                $.ajax({ //获取远程接口的值
                    url: 'http://10.31.163.210/YOHOBUY/php/indexlist-fo.php',
                    dataType: 'json'
                }).done(function(data) {
                    // console.log(data);
                    var strhtml = '';
